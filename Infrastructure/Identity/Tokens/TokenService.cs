...
{
    public class TokenService(UserManager<ApplicationUser> userManger, SchoolTenantInfo tenant, IOptions<JwtSettings> jwtSettings) : ITokenService
    {
        ...
        public async Task<TokenResponse> LoginAsync(TokenRequest request)
        {
            ...
            {
                throw new UnauthorizedException("Invalid credentials: Username or Password");
            }
        ...
        public async Task<TokenResponse> RefreshTokenAsync(RefreshTokenRequest request)
        {
            ...
            var userInDb = await _userManager.FindByEmailAsync(userEmail) ?? throw new UnauthorizedException("Authentication not successful.");
